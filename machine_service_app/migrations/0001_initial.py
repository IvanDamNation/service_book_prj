...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('dictionary_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='machine_service_app.dictionary')),
                ('type_dict', models.CharField(default='Модель машины', editable=False, max_length=32)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='accounts_app.customer', verbose_name='Клиент')),
                ('service_comp', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='machine_service_app.servicecompany', verbose_name='Сервисная компания')),
                ...
                ('front_axle', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='machine_service_app.frontaxle', verbose_name='Модель управляемого моста')),
                ...
                ('rear_axle', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='machine_service_app.rearaxlemodel', verbose_name='Модель ведущего моста')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_order_date', models.DateField(default=models.DateField(default=datetime.date.today, verbose_name='Дата проведения ТО'), verbose_name='Дата заказ-наряда')),
                ('machine', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='machine_service_app.machine', verbose_name='Машина')),
